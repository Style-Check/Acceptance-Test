...
Scenario Outline: Organización y claridad de las preguntas frecuentes
    ...
    And la aplicación recopila una lista de preguntas frecuentes hechas por el usuario
    And las muestra de manera ascendente desde la pregunta más frecuente hasta la pregunta menos frecuente
